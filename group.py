# Combined version of AnalogPositionReader.py, peninfo.py, and servo_motor.py
# Generated by ChatGPT so you can use everything from a single file.
...
PEN_LIFT_ANGLE_DEG = 0.0    # pen off the page 2
PEN_TOUCH_ANGLE_DEG = 0.0  # pen on the page 1
...
# ----------------- Main that reads coordinates from a file -----------------# ----------------- Canvas → arm coordinate transform -----------------
...
CANVAS_TOPLEFT_X_ARM_MM = -140.0   # mm to the right of the shoulder
CANVAS_TOPLEFT_Y_ARM_MM = -63.0    # mm above the shoulder (if +Y is "up" in your setup)
